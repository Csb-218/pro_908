...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <header className="fixed top-0 z-20 w-full shadow-slate-700/5 after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 bg-[#F8EEE8] lg:after:hidden">
